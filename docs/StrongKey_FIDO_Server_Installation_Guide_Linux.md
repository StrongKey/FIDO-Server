...
4.  **Add this lines**  at the end of the file.  
...
1.  **Download**  Payara 4.1 edition  [_.ZIP_  file (_payara-4.1.2.181.zip_)](http://repo1.maven.org/maven2/fish/payara/blue/distributions/payara/4.1.2.181/payara-4.1.2.181.zip).  **Save**  the file.
