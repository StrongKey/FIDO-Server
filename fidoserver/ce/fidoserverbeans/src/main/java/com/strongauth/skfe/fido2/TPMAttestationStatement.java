...
import com.strongauth.skfe.fido2.tpm.Marshal;
import com.strongauth.skfe.fido2.tpm.TPMAttest;
import com.strongauth.skfe.fido2.tpm.TPMECCParameters;
import com.strongauth.skfe.fido2.tpm.TPMECCUnique;
import com.strongauth.skfe.fido2.tpm.TPMPublicData;
import com.strongauth.skfe.fido2.tpm.TPMRSAParameters;
import com.strongauth.skfe.fido2.tpm.TPMRSAUnique;
        ...
        try {
            ...
            switch (pubArea.getAlgType()) {
                ...
                case TPMConstants.TPM_ALG_ECC:
                    String tpmCurve = skfeCommon.getStringFromTPMECCCurveID(((TPMECCParameters) pubArea.getParameters()).getCurveID());
                    String authenticatorDataCurve = skfeCommon.getCurveFromFIDOECCCurveID(((ECKeyObject) authData.getAttCredData().getFko()).getCrv());
            ...
            byte[] attToBeSigned = concatenateArrays(authData.getAuthDataDecoded(), skfeCommon.getDigestBytes(Base64.getDecoder().decode(browserDataBase64), "SHA256"));
            ...
            byte[] hashAttToBeSigned = skfeCommon.getDigestBytes(attToBeSigned, skfeCommon.getHashAlgFromIANACOSEAlg(alg));
            ...
            byte[] pubAreaName = concatenateArrays(Marshal.shortToStream(nameAlg), skfeCommon.getDigestBytes(pubAreaData, skfeCommon.getHashAlgFromTPMAlg(nameAlg)));
