...
public class skceCommon {
    ...
    public static final String defaultprng = getConfigurationProperty("skee.cfg.property.defaultprngalgorithm");
    public static final String PRNGSEEDSIZE = getConfigurationProperty("skee.cfg.property.prng.seedsize");

    // Folder for CryptoEngine where source-files are temporarily stored
    public static final String ENGINE_IN_FOLDER = getConfigurationProperty("skce.cfg.property.defaultinfolder");
