...
public class FidoAdminServlet {
    ...
    @WebMethod(operationName = skfeConstants.CREATE_FIDO_POLICY)
    public String createFidoPolicy(@WebParam(name = "svcinfo") SvcInfoType svcinfo,
        ...
        try {
            ...
            if (!isAuthorized) {
                ...
                return new FIDOResponse("", "", skfeCommon.getMessageProperty("FIDO-ERR-0033")).toString();
            }
            ...
            skfeLogger.log(skfeConstants.SKFE_LOGGER, Level.SEVERE, "SKCEWS-ERR-3000", ex.getLocalizedMessage());
            return new FIDOResponse("", "", ex.getLocalizedMessage()).toString();
        }
    }

    @WebMethod(operationName = skfeConstants.READ_FIDO_POLICY)
    ...
    @WebMethod(operationName = skfeConstants.UPDATE_FIDO_POLICY)
    ...
    @WebMethod(operationName = skfeConstants.DELETE_FIDO_POLICY)
    ...
    private String handleValidationException(ValidationException ex) {
        ...
        skfeLogger.log(skfeConstants.SKFE_LOGGER, Level.SEVERE, "SKCEWS-ERR-3000", error);
