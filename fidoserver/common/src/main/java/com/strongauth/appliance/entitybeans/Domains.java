 ...
 *************************************************
 *
 * Every SKLES is identified uniquely by the domain it "belongs" to.
 * Unlike the DNS, the domain-name is not really relevant in an SKLES;
 * but the domain-identifier is important because this number becomes
 * the first part of all unique identifiers in the SKLES.
 */
