...
8.  **Execute** the _install-skfs.sh_ script as follows:
    ...
    **NOTE: The configuration policy JSON file for the StrongKey FIDO2 Server defaults to the maximum number of options for attestation and encryption settings. See the [StrongKey FIDO2 User Guide](StrongKEy_FIDO_User_Guide.md) for detailed policy information.**
