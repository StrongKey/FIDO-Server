 ...
 * $Date$ $Revision$
 * $Author$ $URL:
 * https://svn.strongauth.com/repos/jade/trunk/skce/skceclient/src/main/java/com/strongauth/skceclient/common/GetManifestFile.java
 * $
 *
 * *********************************************
...
public class GetManifestFile {
     ...
     * @throws Exception
     */
    public String signJar(String jarFileName) throws Exception {
        ...
        try (JarFile jarFile = new JarFile(jarFileName)) {
            ...
            sfpath = _signJarFile(jarFile, outStream);
        }
     ...
     */
    private GetManifestFile.SignatureFile _create_Signature_File(Manifest manifest, MessageDigest messageDigest) throws IOException, IllegalAccessException, NoSuchMethodException, InvocationTargetException,
        ...
        return new GetManifestFile.SignatureFile(new MessageDigest[]{messageDigest}, manifest, manifestDigester, this._alias, true);
    }
     ...
     */
    public String _signJarFile(JarFile jarFile, OutputStream outputStream)
            throws NoSuchAlgorithmException,
            InvalidKeyException,
            SignatureException,
            IOException,
        ...
        GetManifestFile.SignatureFile signatureFile = _create_Signature_File(manifest, messageDigest);
        ...
        String[] n1 = n.split("/");
        String spath = n1[n1.length - 1] + ".sffile";
        try ( //temp
                FileOutputStream fout1 = new FileOutputStream(spath)) {
            signatureFile.write(fout1);
        }
