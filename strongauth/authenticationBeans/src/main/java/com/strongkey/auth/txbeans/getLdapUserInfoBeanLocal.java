 ...
 * *********************************************
 *
 * Local interface for getLdapUserInfoBean
 *
 */
 ...
 */
@Local
public interface getLdapUserInfoBeanLocal {
     ...
     */
    LDAPUserMetadata execute(Long did, String basedn, String searchkey, String searchvalue) throws SKCEException;
}
