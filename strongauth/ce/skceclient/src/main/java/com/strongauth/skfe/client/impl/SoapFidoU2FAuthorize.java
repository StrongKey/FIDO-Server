...
import com.strongauth.skfe.soapstubs.SKCEServiceInfoType;
import com.strongauth.skfe.soapstubs.SKFEServlet;
import com.strongauth.skfe.soapstubs.Soap;
...
public class SoapFidoU2FAuthorize implements FIDOClientAuthorize {

    @Override
    public String u2fAuthorize(String SOAP_URI, 
                                String fidoprotocol, 
                                String skcedid, 
                                String svcuser, 
                                String svcpass, 
                                ...
                                boolean goodsign) 
    {
        try {
            ...
            System.out.println(" Authorization Parameters:");
            ...
            try {
                System.out.println("  **********************************  Authorization : INPUT = " + s2);
