...
public class U2F_SOAP_AuthenticationTest extends TestCase {
    ...
    private String  fidoserverURI   = skfeCommon.getConfigurationProperty("skfe.cfg.property.junit.skfe.url.soap");
    
    //  Test user in LDAP to be used for junit tests.
    private String  testusername   = skfeCommon.getConfigurationProperty("skfe.cfg.property.junit.skfe.testuser");
