...
-   **Download the [Install Scripts Directory](https://github.com/StrongKey/FIDO-Server/tree/master/fidoserver/fidoserverInstall/src)** and place all the following downloads in it.
