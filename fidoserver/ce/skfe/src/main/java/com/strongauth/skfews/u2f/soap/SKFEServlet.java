...
public class SKFEServlet {
            ...
            @WebParam(name = "payload") String payload) 
    {
        ...
        if (svcusername == null || svcusername.isEmpty()) {
            skfeLogger.log(skfeConstants.SKFE_LOGGER,Level.SEVERE, "FIDO-ERR-0002", " credential");
            return skfeCommon.buildPreRegisterResponse(null, "", skfeCommon.getMessageProperty("FIDO-ERR-0002") + " credential");
        }
        if (svcpassword == null) {
            skfeLogger.log(skfeConstants.SKFE_LOGGER,Level.SEVERE, "FIDO-ERR-0002", " credential");
            return skfeCommon.buildPreRegisterResponse(null, "", skfeCommon.getMessageProperty("FIDO-ERR-0002") + " credential");
            ...
            @WebParam(name = "payload") String payload) 
    {
        ...
        if (svcusername == null || svcusername.isEmpty()) {
            skfeLogger.log(skfeConstants.SKFE_LOGGER,Level.SEVERE, "FIDO-ERR-0002", " credential");
            return skfeCommon.buildRegisterResponse(null, "", skfeCommon.getMessageProperty("FIDO-ERR-0002") + " credential");
        }
        if (svcpassword == null) {
            skfeLogger.log(skfeConstants.SKFE_LOGGER,Level.SEVERE, "FIDO-ERR-0002", " credential");
            return skfeCommon.buildRegisterResponse(null, "", skfeCommon.getMessageProperty("FIDO-ERR-0002") + " credential");
            ...
            @WebParam(name = "payload") String payload) 
    {
        ...
        if (svcusername == null || svcusername.isEmpty()) {
            skfeLogger.log(skfeConstants.SKFE_LOGGER,Level.SEVERE, "FIDO-ERR-0002", " credential");
            return skfeCommon.buildPreAuthResponse(null, "", skfeCommon.getMessageProperty("FIDO-ERR-0002") + " credential");
        }
        if (svcpassword == null) {
            skfeLogger.log(skfeConstants.SKFE_LOGGER,Level.SEVERE, "FIDO-ERR-0002", " credential");
            return skfeCommon.buildPreAuthResponse(null, "", skfeCommon.getMessageProperty("FIDO-ERR-0002") + " credential");
            ...
            @WebParam(name = "payload") String payload) 
    {
        ...
        if (svcusername == null || svcusername.isEmpty()) {
            skfeLogger.log(skfeConstants.SKFE_LOGGER,Level.SEVERE, "FIDO-ERR-0002", " credential");
            return skfeCommon.buildAuthenticateResponse(null, "", skfeCommon.getMessageProperty("FIDO-ERR-0002") + " credential");
        }
        if (svcpassword == null) {
            skfeLogger.log(skfeConstants.SKFE_LOGGER,Level.SEVERE, "FIDO-ERR-0002", " credential");
            return skfeCommon.buildAuthenticateResponse(null, "", skfeCommon.getMessageProperty("FIDO-ERR-0002") + " credential");
            ...
            @WebParam(name = "payload") String payload) 
    {
        ...
        if (svcusername == null || svcusername.isEmpty()) {
            skfeLogger.log(skfeConstants.SKFE_LOGGER,Level.SEVERE, "FIDO-ERR-0002", " credential");
            return skfeCommon.buildDeregisterResponse(null, "", skfeCommon.getMessageProperty("FIDO-ERR-0002") + " credential");
        }
        if (svcpassword == null) {
            skfeLogger.log(skfeConstants.SKFE_LOGGER,Level.SEVERE, "FIDO-ERR-0002", " credential");
            return skfeCommon.buildDeregisterResponse(null, "", skfeCommon.getMessageProperty("FIDO-ERR-0002") + " credential");
            ...
            @WebParam(name = "payload") String payload) 
    {
        ...
        if (svcusername == null || svcusername.isEmpty()) {
            skfeLogger.log(skfeConstants.SKFE_LOGGER,Level.SEVERE, "FIDO-ERR-0002", " credential");
            return skfeCommon.buildDeactivateResponse(null, "", skfeCommon.getMessageProperty("FIDO-ERR-0002") + " credential");
        }
        if (svcpassword == null) {
            skfeLogger.log(skfeConstants.SKFE_LOGGER,Level.SEVERE, "FIDO-ERR-0002", " credential");
            return skfeCommon.buildDeactivateResponse(null, "", skfeCommon.getMessageProperty("FIDO-ERR-0002") + " credential");
            ...
            @WebParam(name = "payload") String payload) 
    {
        ...
        try {
            ...
            return skfeCommon.buildActivateResponse(null, "", ex.getLocalizedMessage());
        }
        
        //  2. Input checks
        if (svcusername == null || svcusername.isEmpty()) {
            skfeLogger.log(skfeConstants.SKFE_LOGGER,Level.SEVERE, "FIDO-ERR-0002", " credential");
            return skfeCommon.buildActivateResponse(null, "", skfeCommon.getMessageProperty("FIDO-ERR-0002") + " credential");
        }
        if (svcpassword == null) {
            skfeLogger.log(skfeConstants.SKFE_LOGGER,Level.SEVERE, "FIDO-ERR-0002", " credential");
            return skfeCommon.buildActivateResponse(null, "", skfeCommon.getMessageProperty("FIDO-ERR-0002") + " credential");
            ...
            @WebParam(name = "payload") String payload) 
    {
        ...
        try {
            ...
            return skfeCommon.buildGetKeyInfoResponse(null, "", ex.getLocalizedMessage());
        }
        
        //  2. Input checks
        if (svcusername == null || svcusername.isEmpty()) {
            skfeLogger.log(skfeConstants.SKFE_LOGGER,Level.SEVERE, "FIDO-ERR-0002", " credential");
            return skfeCommon.buildGetKeyInfoResponse(null, "", skfeCommon.getMessageProperty("FIDO-ERR-0002") + " credential");
        }
        if (svcpassword == null) {
            skfeLogger.log(skfeConstants.SKFE_LOGGER,Level.SEVERE, "FIDO-ERR-0002", " credential");
            return skfeCommon.buildGetKeyInfoResponse(null, "", skfeCommon.getMessageProperty("FIDO-ERR-0002") + " credential");
