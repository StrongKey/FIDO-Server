...
public class FIDO2RegistrationChallenge extends U2FChallenge implements Serializable {
   ...
   public FIDO2RegistrationChallenge(String u2fversion, String username) throws SKFEException {
        ...
        nonce = U2FUtility.getRandom(Integer.parseInt(skfeCommon.getConfigurationProperty("skfe.cfg.property.entropylength")));
        userID = U2FUtility.getRandom(Integer.parseInt(skfeCommon.getConfigurationProperty("skfe.cfg.property.fido.userid.length")));   //TODO this should not be randomized if a user already exists
        skfeLogger.logp(skfeConstants.SKFE_LOGGER,Level.FINE, classname, "U2FRegistrationChallenge", skfeCommon.getMessageProperty("FIDO-MSG-5003"), "");
   }
...
//    }
    ...
    public final JsonObject toJsonObject() {
        ...
        JsonObject jsonObj = Json.createObjectBuilder()
                .add(skfeConstants.JSON_KEY_NONCE, this.nonce)
                .add(skfeConstants.JSON_KEY_VERSION, this.version)
                .add(skfeConstants.JSON_KEY_USER_ID, this.userID)
                .build();
