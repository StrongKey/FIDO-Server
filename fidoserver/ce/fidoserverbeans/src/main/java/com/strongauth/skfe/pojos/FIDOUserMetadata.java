...
public class FIDOUserMetadata implements Serializable {
    ...
    public JsonObject getJSONObject() {
        ...
        JsonObject metadataJSON = javax.json.Json.createObjectBuilder()
                ...
                .add(skfeConstants.LDAP_ATTR_KEY_DN, userdn)
                .add(skfeConstants.LDAP_ATTR_KEY_EMAILADDRESSES, emailaddresses)
                .add(skfeConstants.LDAP_ATTR_KEY_PRIMARYEMAIL, primaryemail)
                .add(skfeConstants.LDAP_ATTR_KEY_PHONENUMBERS, phonenumbers)
                .add(skfeConstants.LDAP_ATTR_KEY_PRIMARYPHONE, primaryphone)
                .add(skfeConstants.LDAP_ATTR_KEY_DEFAULTTARGET, defaultcommunication)
                .add(skfeConstants.LDAP_ATTR_KEY_FIDOENABLED, fidokeysenabled)
                .add(skfeConstants.LDAP_ATTR_KEY_2STEPVERIFY, twostepverification)
                .add(skfeConstants.LDAP_ATTR_KEY_DOMAINID, did).
                build();
